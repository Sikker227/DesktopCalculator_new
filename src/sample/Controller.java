...
public class Controller {
    ...
    @FXML
    private Button plus_min_btn;

    @FXML
    private Button equall_btn;
    ...
    void initialize() {
        ...
        multi_btn.setOnAction(event -> mathAction('*'));
        div_btn.setOnAction(event -> mathAction('/'));
        equall_btn.setOnAction(event -> {
        ...
        procent_btn.setOnAction(event -> {
            if(this.str_num != "") {
                ...
                label.setText(this.str_num);
            }
        });
        plus_min_btn.setOnAction(event -> {
            if(this.str_num != "") {
